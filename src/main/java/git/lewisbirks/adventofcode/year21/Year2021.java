...
import git.lewisbirks.adventofcode.year21.day.Day3;
import git.lewisbirks.adventofcode.year21.day.Day4;
...
public class Year2021 extends Year<DayOf2021> {
    ...
    private static final List<DayOf2021> DAYS = List.of(new Day1(), new Day2(), new Day3(), new Day4());
